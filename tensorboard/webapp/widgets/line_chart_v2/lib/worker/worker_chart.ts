...
import {IChart} from './chart_types';
import {
  ChartCallbacks,
  ChartOption,
  DataSeries,
...
const workerPool = new WorkerPool('chart_worker.js');

export class WorkerChart implements IChart {
  ...
  constructor(option: ChartOption) {
    ...
    this.workerInstance = workerPool.getNext();
